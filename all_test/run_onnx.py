...
def get_parser():
    ...
    # add arguments
    parser.add_argument("--device", choices=["cpu","gpu","dtu"], default="cpu", help="backend to use")
...
def run_full_test(nemo_model_name, batch_size, print_predictions, op_args):
    ...
    for test_batch in tqdm(temporary_datalayer):
        ...
        if op_args.device == 'dtu' and op_args.padding_mode:
