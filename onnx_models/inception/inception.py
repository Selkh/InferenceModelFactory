...
class InceptionFactory(OnnxModelFactory):
    model = "inception"
...
class Inception(OnnxModel):
    def __init__(self):
        ...
        self.options.add_argument('--model_path',
                                  default='model/inception_v3-torchvision-op13-fp32-N.onnx',
                                  help='onnx path')
    ...
    def load_data(self, path):
        ...
        label = int(label)
        return InceptionItem(data, name, label)
