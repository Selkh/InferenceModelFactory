...
class ShuffleNetV2Factory(OnnxModelFactory):
    model = "shufflenet_v2"
...
class ShuffleNetV2(OnnxModel):
    def __init__(self):
        ...
        self.options.add_argument('--model_path',
                                  default='model/shufflenet_v2-torchvision-op13-fp32-N-x0_5.onnx',
                                  help='onnx path')
    ...
    def load_data(self, path):
        ...
        label = int(label)
        return ShuffleNetV2Item(data, name, label)
