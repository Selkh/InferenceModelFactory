...
class GoogleNetFactory(OnnxModelFactory):
    model = "googlenet"
...
class GoogleNet(OnnxModel):
    def __init__(self):
        ...
        self.options.add_argument('--model_path',
                                  default='model/googlenet-torchvision-op13-fp32-N.onnx',
                                  help='onnx path')
    ...
    def load_data(self, path):
        ...
        label = int(label)
        return GoogleNetItem(data, name, label)
